...
namespace ConvoPlugin\Convo\Factory;
...
class ConvoServiceFactory
{
	...
	public function __construct(
        ...
        \ConvoPlugin\Convo\IServiceDataProvider $convoServiceDataProvider
    )
	{
		$this->_logger							=	$logger;
...
// 		}
	...
	public function migrateService(  $user, $serviceId,  $provider) {
