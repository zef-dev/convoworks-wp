...
{
    public const NAMESPACE = 'convo-alexa';
        ...
        return [
            ...
            new ComponentDefinition(
                ...
                [
                    ...
                    '_factory' => new class ($this->_alexaCustomerProfileApi, $this->_alexaPersonProfileApi, $this->_alexaRemindersApi, $this->_convoServiceDataProvider) implements IComponentFactory {
                        private $_alexaCustomerProfileApi;
                        private $_alexaPersonProfileApi;
            ...
            new ComponentDefinition(
                ...
                [
                    ...
                    '_factory' => new class ($this->_alexaDeviceAddressApi, $this->_convoServiceDataProvider) implements IComponentFactory {
                        private $_alexaDeviceAddressApi;
                        private $_convoServiceDataProvider;
            ...
            new \Convo\Core\Factory\ComponentDefinition(
                ...
                [
                    'use_apl_user_event_argument_part' => [
                        'editor_type' => 'boolean',
                        'editor_properties' => [],
                        'defaultValue' => false,
            ...
            new \Convo\Core\Factory\ComponentDefinition(
                ...
                [
                    ...
                    'command_auto_page_component_id' => [
                        'editor_type' => 'text',
                        'editor_properties' => [
                    ...
                    'command_back_go_back_use_back_type' => [
                        'editor_type' => 'boolean',
                        'editor_properties' => [
                    ...
                    'command_back_go_back_back_type' => [
                        'editor_type' => 'select',
                        'editor_properties' => [
                    ...
                    'command_back_go_back_back_value' => [
                        'editor_type' => 'text',
                        'editor_properties' => [
                            'dependency' => "component.properties.command_type === 'Back:GoBack' && component.properties.command_back_go_back_use_back_type === true"
                        ],
                    ...
                    'command_scroll_to_component_component_id' => [
                        'editor_type' => 'text',
                        'editor_properties' => [
                    ...
                    'command_scroll_to_component_align' => [
                        'editor_type' => 'select',
                        'editor_properties' => [
                            'dependency' => "component.properties.command_type === 'ScrollToComponent'",
                    ...
                    'command_scroll_to_index_component_id' => [
                        'editor_type' => 'text',
                        'editor_properties' => [
                    ...
                    'command_set_focus_component_id' => [
                        'editor_type' => 'text',
                        'editor_properties' => [
                    ...
                    'command_set_value_component_id' => [
                        'editor_type' => 'text',
                        'editor_properties' => [
                    ...
                    'command_speak_item_component_id' => [
                        'editor_type' => 'text',
                        'editor_properties' => [
                    ...
                    'command_speak_item_highlight_mode' => [
                        'editor_type' => 'select',
                        'editor_properties' => [
                            'dependency' => "component.properties.command_type === 'SpeakItem'",
                    ...
                    'command_speak_item_minimum_dwell_time' => [
                        'editor_type' => 'text',
                        'editor_properties' => [
                            'dependency' => "component.properties.command_type === 'SpeakItem'",
                        ],
                    ...
                    'command_speak_list_component_id' => [
                        'editor_type' => 'text',
                        'editor_properties' => [
                    ...
                    'command_speak_list_minimum_dwell_time' => [
                        'editor_type' => 'text',
                        'editor_properties' => [
                            'dependency' => "component.properties.command_type === 'SpeakList'",
                        ],
            ...
            new ComponentDefinition(
                ...
                [
                    'alexa_prompts' => [
                        'editor_type' => 'service_components',
                        'editor_properties' => [
                            'allow_interfaces' => ['\Convo\Pckg\Alexa\Elements\IAlexaDialogPrompt'],
                            'multiple' => true
                        ],
                        'defaultValue' => [],
                        'defaultOpen' => true,
                    ...
                    'validation_rule_is_greater_than' => [
                        'editor_type' => 'text',
                        'editor_properties' => [
                    ...
                    'validation_rule_is_greater_than_or_equal_to' => [
                        'editor_type' => 'text',
                        'editor_properties' => [
                    ...
                    'validation_rule_is_less_than_or_equal_to' => [
                        'editor_type' => 'text',
                        'editor_properties' => [
                    ...
                    'validation_rule_is_in_duration_start' => [
                        'editor_type' => 'text',
                        'editor_properties' => [
                    ...
                    'validation_rule_is_in_duration_end' => [
                        'editor_type' => 'text',
                        'editor_properties' => [
                            'dependency' => "component.properties.validation_rule === 'isInDuration'"
                        ],
                    ...
                    'validation_rule_is_not_in_duration_start' => [
                        'editor_type' => 'text',
                        'editor_properties' => [
                    ...
                    'validation_rule_is_not_in_duration_end' => [
                        'editor_type' => 'text',
                        'editor_properties' => [
                            'dependency' => "component.properties.validation_rule === 'isNotInDuration'"
                        ],
            ...
            new \Convo\Core\Factory\ComponentDefinition(
                ...
                [
                    ...
                    'request_filters' => [
                        'editor_type' => 'service_components',
                        'editor_properties' => [
                            'allow_interfaces' => ['\Convo\Pckg\Alexa\Filters\IAlexaDialogIntentFilter'],
                            'multiple' => true
                        ],
                        'defaultValue' => [],
                        'defaultOpen' => true,
            ...
            new \Convo\Core\Factory\ComponentDefinition(
                ...
                [
                    ...
                    'intent_slot_dialog_filters' => [
                        'editor_type' => 'service_components',
                        'editor_properties' => [
                            'allow_interfaces' => ['\Convo\Pckg\Alexa\Filters\IAlexaDialogIntentSlotFilter'],
                            'multiple' => true
                        ],
                        'defaultValue' => [],
                        'defaultOpen' => true,
            ...
            new \Convo\Core\Factory\ComponentDefinition(
                ...
                [
                    ...
                    'dialog_validation_rules' => [
                        'editor_type' => 'service_components',
                        'editor_properties' => [
                            'allow_interfaces' => ['\Convo\Pckg\Alexa\Elements\IAlexaDialogSlotValidator'],
                            'multiple' => true
                        ],
                        'defaultValue' => [],
                        'defaultOpen' => true,
                    ...
                    'intent_slot_confirmation_alexa_prompts' => [
                        'editor_type' => 'service_components',
                        'editor_properties' => [
                            'allow_interfaces' => ['\Convo\Pckg\Alexa\Elements\IAlexaDialogPrompt'],
                            'multiple' => true
