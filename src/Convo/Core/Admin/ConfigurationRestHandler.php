...
class ConfigurationRestHandler implements \Psr\Http\Server\RequestHandlerInterface
{
    ...
    private function _handleConfigOptionsGet(IAdminUser $user)
    {
        ...
        $data = [
            ...
            'CONVO_AMAZON_SKILL_ACCOUNT_LINKING_SCOPES' => [
                ['name' => 'profile', 'checked' => false],
                ['name' => 'profile:user_id', 'checked' => false],
                ['name' => 'postal_code', 'checked' => false]
            ],
            'CONVO_AMAZON_SKILL_PERMISSIONS' => [
                ['value' => 'alexa::profile:name:read', 'name' => 'Full Name', 'checked' => false],
                ['value' => 'alexa::profile:given_name:read', 'name' => 'Given Name', 'checked' => false],
                ...
                ['value' => 'alexa::devices:all:address:full:read', 'name' => 'Full Address', 'checked' => false],
                ['value' => 'alexa:devices:all:address:country_and_postal_code:read', 'name' => 'Country/Region & Postal Code Only', 'checked' => false],
