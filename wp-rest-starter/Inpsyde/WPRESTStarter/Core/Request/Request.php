...
final class Request extends \WP_REST_Request implements ServerRequestInterface
{
     ...
     * @return static
     */
    public function withHeader($name, $value): \Psr\Http\Message\RequestInterface
    {
     ...
     * @return static
     */
    public function withAddedHeader($name, $value): \Psr\Http\Message\RequestInterface
    {
     ...
     * @return static
     */
    public function withoutHeader($name): \Psr\Http\Message\RequestInterface
    {
     ...
     * @return static
     */
    public function withBody(StreamInterface $body): \Psr\Http\Message\RequestInterface
    {
     ...
     * @return static
     */
    public function withRequestTarget($request_target): \Psr\Http\Message\RequestInterface
    {
     ...
     * @return static
     */
    public function withUri(UriInterface $uri, $preserve_host = false): \Psr\Http\Message\RequestInterface
    {
     ...
     * @return static
     */
    public function withUploadedFiles(array $uploaded_files): \Psr\Http\Message\ServerRequestInterface
    {
     ...
     * @return static
     */
    public function withParsedBody($body): \Psr\Http\Message\ServerRequestInterface
    {
